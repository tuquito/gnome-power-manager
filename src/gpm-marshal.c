                                     ...
                                     gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT_UINT_BOOLEAN) (gpointer     data1,
                                                        ...
                                                        gboolean     arg_3,
                                                        gpointer     data2);
  register GMarshalFunc_VOID__UINT_UINT_BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
                                                         ...
                                                         gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__STRING_STRING_BOOLEAN_BOOLEAN_BOOLEAN) (gpointer     data1,
                                                                            ...
                                                                            gboolean     arg_5,
                                                                            gpointer     data2);
  register GMarshalFunc_VOID__STRING_STRING_BOOLEAN_BOOLEAN_BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
                                            ...
                                            gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_LONG_BOOLEAN_BOOLEAN) (gpointer     data1,
                                                               ...
                                                               gboolean     arg_4,
                                                               gpointer     data2);
  register GMarshalFunc_VOID__INT_LONG_BOOLEAN_BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
